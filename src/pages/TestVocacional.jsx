...
export default function TestVocacional() {
  ...
  if (typeof guardarResultadoTest === 'function') {
    await guardarResultadoTest(carreraFinalAAsignar);   // 👈 el await es clave
  }
} else {
          ...
          <div className="grid gap-4">
            {preguntas[currentPregunta].opciones.map((opcion, index) => (
              <button
                ...
                className="w-full text-left bg-slate-50 hover:bg-linear-to-r hover:from-blue-50/40 hover:to-teal-50/40 border-2 border-slate-100 hover:border-blue-400 p-5 rounded-2xl font-medium text-slate-700 hover:text-blue-900 transition-all duration-200 shadow-xs flex items-center gap-4 group cursor-pointer"
              >
