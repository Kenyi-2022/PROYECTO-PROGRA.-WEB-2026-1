        ...
        <div className="bg-white rounded-3xl shadow-xl border border-slate-100 p-8 space-y-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" disabled={cargando}
              className={`w-full bg-gradient-to-r ${isProfesor ? 'from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700' : 'from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700'} text-white font-extrabold py-3.5 rounded-xl shadow-lg transition-all cursor-pointer disabled:opacity-60 mt-2`}>
