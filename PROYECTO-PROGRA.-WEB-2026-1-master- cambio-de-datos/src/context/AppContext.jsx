...
const actualizarUsuario = (camposActualizados) => {
  const usuarioActualizado = { ...user, ...camposActualizados };
  ...
  marcarFavoritoContext, carreraTemporal, setCarreraTemporal,
  actualizarUsuario  // 👈 agregar esto
}}>
      {children}
    </AppContext.Provider>
  );
